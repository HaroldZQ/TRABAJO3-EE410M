...
$$Convolucion :f[n]*f[n]$$ 
\begin{center}
\includegraphics[scale=0.70]{../Imagenes de señales problema 2/ffgrafica.png} 
\end{center}
$$Convolucion :f[n]*g[n]$$
\begin{center}
\includegraphics[scale=0.70]{../Imagenes de señales problema 2/fggrafica.png} 
\end{center}
$$Convolucion :f[n]*h[n]$$
\begin{center}
\includegraphics[scale=0.70]{../Imagenes de señales problema 2/fh.png} 
\end{center}
$$Convolucion :g[n]*g[n]$$
\begin{center}
\includegraphics[scale=0.70]{../Imagenes de señales problema 2/gg.png} 
\end{center}
$$Convolucion :g[n]*h[n]$$
\begin{center}
\includegraphics[scale=0.70]{../Imagenes de señales problema 2/gh.png} 
\end{center}
$$Convolucion :h[n]*h[n]$$
\begin{center}
\includegraphics[scale=0.7]{../Imagenes de señales problema 2/hh.png} 
\end{center}
$$$$
$$$$
$$$$
